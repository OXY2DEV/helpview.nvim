...
colors.mix = function (color_1, color_2, per_1, per_2)
	...
	if type(color_1) == "table" then
		c_1 = color_1;
	elseif type(color_1) == "number" then
		c_1 = colors.num_to_rgb(color_1);
	...
	if type(color_2) == "table" then
		c_2 = color_2;
	elseif type(color_2) == "number" then
		c_2 = colors.num_to_rgb(color_2);
